...
function raiseToPower(num, exponent) {
  // raise num to whatever power is passed in as exponent
  // code here
  return raiseToPower(num ,exponent)
}
...
function combineNames(firstName, lastName) {
  ...
  // 'Lambda', 'School' -> 'Lambda School'
  // code here
  const hellostring ='firstName ' + 'lastName'
  const twostring = combineNames('Lambda', 'School' + 'Lambda School')
  return hellostring;
  return twostring;
}
...
function getGreeting(name) {
  ...
  // 'Sam' -> 'Hello Sam!'
  // code here
  const name ='first' + 'Hello Sam!'
  const name = getGreeting ('sam');
  return getGreeting;
